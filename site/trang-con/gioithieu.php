        ...
        <div id="band" class="content-selection">
            ...
            <div class="members-list">
                <div class="col col-three text-center">
                    ...
                    <img class="members-img" src="../../site/trang-con/image/4.jpg" alt="Ninh">
                </div>

                <div class="col col-three text-center">
                    <p class="members-name">Hoàng Kim Thắng</p>
                    <img class="members-img" src="../../site/trang-con/image/3.jpg" alt="Ninh">
                </div>

                <div class="col col-three text-center">
                    <p class="members-name">Nguyễn Thanh Ninh</p>
                    <img class="members-img" src="../../site/trang-con/image/5.jpg" alt="Ninh">
                </div>
